...
```
  bbp-atlas  --target-rule push_atlas_release  --snakemake-options '--cores 1  --config NEXUS_REGISTRATION=False'
```
...
The following command:
```
  bbp-atlas  --target-rule push_cellcomposition  --snakemake-options '--cores 1  --config NEXUS_REGISTRATION=False'
```
...
The following command:
```
  bbp-atlas  --target-rule push_atlas_datasets  --snakemake-options '--cores 1  --config NEXUS_REGISTRATION=False'
```
